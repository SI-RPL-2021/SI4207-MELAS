    ...
    <ul class="navbar-nav ml-auto">
      <div class="my-2 my-lg-0 d-flex align-items-center topBar">
        <div class="hello d-flex mr-5">
          ...
          <a class="my-2 my-sm-0 font-weight-bold" href="#">Hai, <?php echo  $_SESSION["admin"]["nama"] ?></a>
        </div>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto font-weight-bold mr-5">
        <li class="nav-item mr-5">
          <a class="nav-link text-white" href="history_pembayaran.php">History Pembayaran</a>
        </li>
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
            <a class="dropdown-item" href="tilang.php">Tilang</a>
            <a class="dropdown-item" href="list_portal.php">Portal Berita</a>
            <a class="dropdown-item" href="aduan_apresiasi.php">Pengaduan / Apresiasi</a>
            <a class="dropdown-item" href="respon_pengawalan.php">Respon Pengawalan</a>
            <a class="dropdown-item" href="respon_keramaian.php">Respon Keramaian</a>
            <a class="dropdown-item" href="data_demo.php">Laporan Demo</a>
            <a class="dropdown-item" href="data_pendaftar_catar.php">Pendaftaran Catar</a>
            <a class="dropdown-item" href="sim_stnk_skck.php">Pembuatan SIM, STNK, SKCK</a>
