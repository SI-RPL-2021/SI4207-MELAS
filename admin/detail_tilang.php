...
includeWithVariables('./layout/header.php', array('webTitle' => 'Detail Informasi Tilang - MELAS'));
require_once('../config.php');
require_once('../format.php');

$query = mysqli_query($koneksi, "SELECT * FROM tbl_tilang WHERE no_tilang = '$_GET[no]'");
...
<main>
  <div class="title-bar d-flex justify-content-center">
    <h2 class="text-white font-weight-bold">DETAIL INFORMASI TILANG</h2>
  </div>
  ...
  <section class="content">
    <div class="container text-white d-flex flex-column align-items-center mt-5">
      ...
      <div class="perkara d-flex flex-column align-items-center mt-5 mb-3" style="width: 100%;">
        <div class="body d-flex justify-content-between" style="width:90%;">
          <div class="left" style="width:50%; text-align:left;">
            <h6 class="mt-2"><a class="btn button-submit" href="tilang.php">Kembali</a></h6>
          </div>
        </div>
      </div>
