$(document).ready(function () {
  ...
  $('#table_tilang').DataTable({
    info: false,
    dom: '<"top"fls><bottam>p',
    language: {
      lengthMenu:
        "<div class='tableTitle'><p id='titleSIM'>TABLE DATA TILANG</p></div>",
      zeroRecords: 'Tidak ada data.',
      search: '_INPUT_',
      searchPlaceholder: 'Cari...',
    },
  ...
  $('#btn-lanjut-pelanggaran').on('click', function () {
    $('#pelanggaran').addClass('hidden');
    $('#kendaraan').removeClass('hidden');
  });

  $('#btn-lanjut-kendaraan').on('click', function () {
    $('#kendaraan').addClass('hidden');
    $('#penindak').removeClass('hidden');
  });

  $('#btn-kembali-kendaraan').on('click', function () {
    $('#pelanggaran').removeClass('hidden');
    $('#kendaraan').addClass('hidden');
  });

  $('#btn-lanjut-penindak').on('click', function () {
    $('#penindak').addClass('hidden');
    $('#pengadilan').removeClass('hidden');
  });

  $('#btn-kembali-penindak').on('click', function () {
    $('#kendaraan').removeClass('hidden');
    $('#penindak').addClass('hidden');
  });

  $('#btn-kembali-pengadilan').on('click', function () {
    $('#penindak').removeClass('hidden');
    $('#pengadilan').addClass('hidden');
  });

  $('#bukti').on('keyup', function () {
    $('#no_bukti').attr('placeholder', 'Masukan Nomor ' + $('#bukti').val());
    $('#label_no_bukti').text('Nomor ' + $('#bukti').val());
  });
